angular.module('RomeoApp').run(['$templateCache', function($templateCache) {   'use strict';
  ...
  $templateCache.put('organise-video-list.html',
    ...
    "      Sort:\n" +
    "      <select class=\"organise-video-list__select button button--small\"\n" +
    "        ng-model=\"sortOption\"\n" +
    "        ng-init=\"sortOption=''\">\n" +
    ...
    "    <label class=\"organise-video-list__list-control-label\">\n" +
    "      View:\n" +
    "      <a class=\"inline-space-fix button button__component button__component--left\"\n" +
    "        ng-class=\"{ 'organise-video-list__list-control--active button--active' : !isList }\"\n" +
    "        ng-click=\"isList = false\">G</a>\n" +
    "      <a class=\"button button__component button__component--right\"\n" +
    "        ng-class=\"{ 'organise-video-list__list-control--active button--active' : isList }\"\n" +
    "        ng-click=\"isList = true\">L</a>\n" +
    "    </label>\n" +
    "  </section>\n" +
    "\n" +
  ...
  $templateCache.put('organise-video.html',
    ...
    "      <a class=\"organise-video__inline-link organise-video__inline-link--edit\" ng-href=\"#/video/(~video.id~)/edit\">E</a>\n" +
    "    </li>\n" +
    "    <li class=\"organise-video__inline-control\">\n" +
    "      <a class=\"organise-video__inline-link organise-video__inline-link--stats\">S</a>\n" +
    "    </li>\n" +
    "    <li class=\"organise-video__inline-control\">\n" +
    "      <a class=\"organise-video__inline-link organise-video__inline-link--add-remove\" ng-click=\"addRemove(video)\">A/R</a>\n" +
    "    </li>\n" +
    "    <li class=\"organise-video__inline-control\">\n" +
    "      <a class=\"organise-video__inline-link organise-video__inline-link--delete\" ng-click=\"delete(video)\">D</a>\n" +
    "    </li>\n" +
    "  </ul>\n" +
    "\n" +
  ...
  $templateCache.put('video-more-link.html',
    ...
    "\n" +
    "  <a class=\"video-more__link button\" ng-click=\"(showMoreLinkConfigPanel = !showMoreLinkConfigPanel)\" ng-show=\"isEdit\">(~ text ? text : 'Add a link (optional) &hellip;' ~)</a>\n" +
    "\n" +
