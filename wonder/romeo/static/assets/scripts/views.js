angular.module('RomeoApp').run(['$templateCache', function($templateCache) {   'use strict';
  ...
  $templateCache.put('login.html',
    ...
    "\r" +
    "\n" +
    "<div id=\"page-login\" class=\"page section\" ng-controller=\"LoginController\">\r" +
    "\n" +
    "\t<div class=\"inner\">\r" +
    "\n" +
    "\t\t<h1>Login</h1>\r" +
    ...
    "\n" +
    "\t\t\t\t<input type=\"text\" name=\"username\" ng-model=\"username\">\r" +
    "\n" +
    "\t\t\t</div>\r" +
    "\n" +
    "\t\t\t<div class=\"row\">\r" +
    ...
    "\n" +
    "\t\t\t\t<input type=\"password\" name=\"password\" ng-model=\"password\">\r" +
    "\n" +
    "\t\t\t</div>\r" +
    "\n" +
    "\t\t\t<div class=\"row\">\r" +
...
<<<<<<< HEAD
    ...
    "\t</div>\n" +
=======
>>>>>>> 44f1daadc83e35c1173a5762540a6bfccb10802c
    "</div>"
  );
