angular.module('RomeoApp').run(['$templateCache', function($templateCache) {   'use strict';
  ...
  $templateCache.put('account.html',
    ...
    "\n" +
    "\t\t\t<div class=\"avatar inline-block\">\r" +
    "\n" +
    "\t\t\t\t<span class=\"icon-user2\">\r" +
    "\n" +
    "\t\t\t\t\t<a href=\"/#/account\">Change Avatar</a>\r" +
    "\n" +
    "\t\t\t\t</span>\r" +
    "\n" +
    "\t\t\t</div>\r" +
    "\n" +
    "\t\t\t<form class=\"inline-block\" ng-submit=\"saveUser($event)\">\r" +
    "\n" +
    "\t\t\t\t<div class=\"row left half-width\">\r" +
    "\n" +
    "\t\t\t\t\t<label>First Name</label>\r" +
    "\n" +
    "\t\t\t\t\t<input type=\"text\" ng-model=\"user.firstName\">\r" +
    "\n" +
    "\t\t\t\t</div><!--\r" +
    "\n" +
    ...
    "\n" +
    "\t\t\t\t\t<input type=\"text\" ng-model=\"user.lastName\">\r" +
    "\n" +
    "\t\t\t\t</div><!--\r" +
    "\n" +
    "\t\t\t\t--><div class=\"row left half-width\">\r" +
    ...
    "\n" +
    "\t\t\t\t\t<input type=\"text\" ng-model=\"user.location\">\r" +
    "\n" +
    "\t\t\t\t</div><!--\r" +
    "\n" +
    "\t\t\t\t--><div class=\"row half-width\">\r" +
    "\n" +
    "\t\t\t\t\t<label>Email address <span>(<a ng-click=\"changeEmailAddress($event)\">Change?</a>)</span></label>\r" +
    "\n" +
    "\t\t\t\t\t<input type=\"text\" ng-model=\"user.email\" class=\"pl-disabled\" ng-click=\"changeEmailAddress($event)\">\r" +
    "\n" +
    "\t\t\t\t</div><!--\r" +
    "\n" +
    "\t\t\t\t--><div class=\"row left half-width\">\r" +
    "\n" +
    "\t\t\t\t\t<label>Username <span>(<a ng-click=\"changeUsername($event)\">Change?</a>)</span></label>\r" +
    "\n" +
    "\t\t\t\t\t<input type=\"text\" ng-model=\"user.username\" class=\"pl-disabled\" ng-click=\"changeUsername($event)\">\r" +
    "\n" +
    "\t\t\t\t</div><!--\r" +
    "\n" +
    "\t\t\t\t--><div class=\"row half-width\">\r" +
    "\n" +
    "\t\t\t\t\t<label>Password <span>(<a ng-click=\"changePassword($event)\">Change?</a>)</span></label>\r" +
    "\n" +
    "\t\t\t\t\t<input type=\"password\" ng-model=\"user.password\" class=\"pl-disabled\" ng-click=\"changePassword($event)\">\r" +
    "\n" +
    "\t\t\t\t</div><!--\r" +
    "\n" +
    "\t\t\t\t--><div class=\"row half-width\">\r" +
    "\n" +
    "\t\t\t\t\t<input type=\"submit\" value=\"Update my details\" ng-class=\"{ active: checkEquals(blueprint,user) }\">\r" +
    "\n" +
    "\t\t\t\t</div>\r" +
    "\n" +
    "\t\t\t</form>\r" +
  ...
  $templateCache.put('analytics.html',
    ...
    "\r" +
    "\n" +
    "    <div class=\"inner\" ng-if=\"isState('complete')\">\r" +
    "\n" +
    "\r" +
    "\n" +
    "        <!-- Header -->\r" +
    ...
    "            <!--  Title -->\r" +
    "\n" +
    "            <h1 id=\"analytics-title\">Stats for <( video.title )></h1>\r" +
    "\n" +
    "\r" +
    "\n" +
    "            <!-- Tabs -->\r" +
    ...
    "                <ul>\r" +
    "\n" +
    "                    <li class=\"analytics-tabs-tab\" ng-class=\"{ selected: isSection('overview') }\">\r" +
    "\n" +
    "                        <a href=\"/#/analytics/<( video.videoID )>/overview\" class=\"icon-analytics\">Overview</a>\r" +
    "\n" +
    "                    </li>\r" +
    "\n" +
    "                    <li class=\"analytics-tabs-tab\" ng-class=\"{ selected: isSection('performance') }\">\r" +
    "\n" +
    "                        <a href=\"/#/analytics/<( video.videoID )>/performance\" class=\"icon-graph\">Performance</a>\r" +
    "\n" +
    "                    </li>\r" +
    "\n" +
    "                    <li class=\"analytics-tabs-tab\" ng-class=\"{ selected: isSection('geographic') }\">\r" +
    "\n" +
    "                        <a href=\"/#/analytics/<( video.videoID )>/geographic\" class=\"icon-earth\">Geographic</a>\r" +
    "\n" +
    "                    </li>\r" +
    "\n" +
    "                    <li class=\"analytics-tabs-tab\" ng-class=\"{ selected: isSection('engagement') }\">\r" +
    "\n" +
    "                        <a href=\"/#/analytics/<( video.videoID )>/engagement\" class=\"icon-user\">Engagement</a>\r" +
    "\n" +
    "                    </li>\r" +
    "\n" +
    "                </ul>\r" +
    ...
    "\n" +
    "                    <span><( analytics.dateRange.from | formatDate )> - <( analytics.dateRange.to | formatDate )></span>\r" +
    "\n" +
    "                </div>\r" +
    "\n" +
    "            </div>\r" +
    ...
    "\n" +
    "            <div pl-analytics-overview ng-if=\"isSection('overview')\"></div>\r" +
    "\n" +
    "            <div pl-analytics-performance-chart ng-if=\"isSection('performance')\"></div>\r" +
    "\n" +
    "            <div pl-analytics-geographic-map ng-if=\"isSection('geographic')\"></div>\r" +
    "\n" +
    "        </div>\r" +
    "\n" +
    "\r" +
    ...
    "        <!-- Bottom Panel -->\r" +
    "\n" +
    "        <div id=\"analytics-bottom-panel\">\r" +
    "\n" +
    "            <div pl-analytics-fields-key ng-if=\"isSection('performance') || isSection('geographic')\"></div>\r" +
    "\n" +
    "            <div pl-analytics-fields-chooser ng-if=\"isSection('performance') || isSection('geographic')\"></div>\r" +
    "\n" +
    "            <div pl-analytics-results ng-if=\"isSection('performance') || isSection('geographic')\"></div>\r" +
    "\n" +
  ...
  $templateCache.put('library.html',
    ...
    "\n" +
    "\t\t\t\t<a class=\"button icon-list right\"></a>\r" +
    "\n" +
    "\t\t\t\t<a class=\"button icon-layout right\"></a>\r" +
    "\n" +
    "\t\t\t\t<h2 ng-show=\"selectedItems.length == 0\">Videos</h2>\r" +
    "\n" +
    "\t\t\t\t<div id=\"selection-status\" ng-class=\"{ show: selectedItems.length > 0 }\">\r" +
    "\n" +
    "\t\t\t\t\t<span><( selectedItems.length )> video<span ng-show=\"selectedItems.length > 1\">s</span> selected: <a ng-click=\"showAddToCollectionForm($event)\">Add to a collection</a> / <a href=\"#\">View analytics</a></span>\r" +
    "\n" +
    "\t\t\t\t</div>\t\t\t\t\r" +
    "\n" +
    "\t\t\t\t<div class=\"clear\"></div>\r" +
    ...
    "\r" +
    "\n" +
    "\t\t\t<ul id=\"video-list\" ng-class=\"{ loading: loading }\">\r" +
    "\n" +
    ...
    "\n" +
    "\t\t\t\t\t\t<span class=\"number-of-collections\">( in <span pl-tooltip=\"<( listCollections(video.collections) )>\" ng-class=\"{ active: listCollections(video.collections).length > 0}\"><( video.collections.length )> collections</span> )</span>\r" +
    "\n" +
    "\t\t                <!-- <div class=\"inline-wrapper\">\r" +
    "\n" +
    "\t\t                    <span class=\"title\"><a href=\"/#/video/<( key )>\"><( video.title )></a></span>\r" +
    "\n" +
    "\t\t                    <ul class=\"collections\">\r" +
    "\n" +
    "\t\t                    \t<li class=\"label\">Collections ( <( video.collections.length )> ) :</li>\r" +
    "\n" +
    "\t\t                        <li ng-repeat=\"collection in video.collections\" class=\"collection\">\r" +
    "\n" +
    "\t\t                            <a class=\"label\" ng-click=\"filterByCollection($event, collection.id)\"><( collection )></a>\r" +
    "\n" +
    "\t\t                        </li>\r" +
    "\n" +
    "\t\t                    </ul>\r" +
    ...
    "\n" +
    "                <li pl-droppable ng-repeat=\"(key, collection) in collections\" data-collection=\"<( $index )>\" ng-class=\"{ highlighted: filter.collection == key }\">\r" +
    "\n" +
    "                    <span class=\"title\" ng-click=\"filterByCollection($event, key)\"><( collection.label )></span>\r" +
    "\n" +
    "                    <a class=\"info\" ng-click=\"editCollection($event, collection.label, $index)\">Edit</a>\r" +
    "\n" +
    "                </li>\r" +
    "\n" +
    "\t\t\t</ul>\r" +
  ...
  $templateCache.put('modal-edit-collection.html',
    ...
    "\n" +
    "<form name\"editCollectionForm\" ng-submit=\"updateCollection(data)\">\r" +
    "\n" +
    "\t<div class=\"row\">\r" +
    "\n" +
  ...
  $templateCache.put('modal-new-collection.html',
    ...
    "\n" +
    "<form name\"newCollectionForm\" ng-submit=\"saveCollection(data)\">\r" +
    "\n" +
    "\t<div class=\"row\">\r" +
    "\n" +
  ...
  $templateCache.put('upload.html',
    ...
    "\t\t<!-- STAGE ONE -->\r" +
    "\n" +
    "\t\t<div class=\"inner half-width centered\" ng-if=\"fileDropped == false\">\r" +
    "\n" +
    "\t\t\t<div id=\"upload-dropzone\" class=\"pl-upload-dropzone\">\r" +
    "\n" +
    "\t\t\t\t<label>\r" +
    "\n" +
    "\t\t\t\t\tDrag your videos here to upload and transcode them.<br/>\r" +
    "\n" +
    ...
    "\t\t</div><!--\r" +
    "\n" +
    "\t\t<div class=\"inner half-width\" ng-if=\"fileDropped == false\">\r" +
    "\n" +
    "\t\t\t<div id=\"upload-instructions\">\r" +
    "\n" +
    "\t\t\t\t<div class=\"tooltip\">\r" +
    "\n" +
    "\t\t\t\t\t<h4><span class=\"icon-info\"></span>Uploading your content is easy</h4>\r" +
    "\n" +
    "\t\t\t\t\t<ul>\r" +
    "\n" +
    "\t\t\t\t\t\t<li>&bull; Lorem ipsum dolor sit amet, consectetur adipisicing elit.</li>\r" +
    "\n" +
    "\t\t\t\t\t\t<li>&bull; Quos, doloremque aperiam molestias magni dolore beatae enim non dolorem.</li>\r" +
    "\n" +
    "\t\t\t\t\t\t<li>&bull; Ipsum facere aperiam saepe voluptate magnam minima velit ratione ad ea qui.</li>\r" +
    "\n" +
    "\t\t\t\t\t</ul>\r" +
    "\n" +
    "\t\t\t\t</div>\r" +
    ...
    "\n" +
    "\t\t\t\t\t\t<select class=\"actions\" ng-options=\"collection.title for collection in collections\" ng-model=\"newVideo.collections\"></select>\r" +
    "\n" +
    "\t\t\t\t\t</div>\r" +
    "\n" +
    "\t\t\t\t\t<div class=\"row\">\r" +
  ...
  $templateCache.put('video.html',
    ...
    "\t\t</div><!--\r" +
    "\n" +
    "\t\t--><div class=\"inner half-width right\">\r" +
    "\n" +
    ...
    "\t\t\t</div>\r" +
    "\n" +
    "\t\t\t<h3>Customise your embeddable player</h3>\r" +
    "\n" +
