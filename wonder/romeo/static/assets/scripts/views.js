angular.module('RomeoApp').run(['$templateCache', function($templateCache) {   'use strict';
  ...
  $templateCache.put('modal-preview-image-picker.html',
    ...
    "\t\t<p>Frame: (~ previewIndex ~) / (~ previewImages.length ~)</p>\n" +
  ...
  $templateCache.put('upload.html',
    ...
    "\t\t\t\t\t\t<div ng-show=\"chosenPreviewImage != null\" style=\"background: black url((~ chosenPreviewImage ~)) center center no-repeat; background-size: cover;\"></div>\n" +
    "\t\t\t\t\t</div>\n" +
    "\n" +
    "\t\t\t\t\t<div class=\"dialogs\">\n" +
    "\t\t\t\t\t\t\n" +
    ...
    "\t\t\t\t</div>\n" +
    "\t\t\t\t\n" +
    "\t\t\t\t<div id=\"wonderplayer\" class=\"web-lite-player\">\n" +
