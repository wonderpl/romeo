angular.module('RomeoApp').run(['$templateCache', function($templateCache) {   'use strict';
  ...
  $templateCache.put('modal-create-new-collection.html',
    ...
    "            </li>\n" +
    "          </ul>\n" +
    "          <input type=\"hidden\" ng-model=\"collection.scope\" value=\"private\" ng-if=\"showOnlyPrivate\" />\n" +
    "        </fieldset>\n" +
    "      </form>\n" +
    "    </div>\n" +
    "  </div>\n" +
  ...
  $templateCache.put('video-extended-controls.html',
    ...
    "    <collection-add-video available-tags=\"availableTags\"\n" +
    "      video=\"video\"\n" +
  ...
  $templateCache.put('pages/faq.tmpl.html',
  ...
  $templateCache.put('pages/home.tmpl.html',
    "<div>\n" +
    "<h1>Welcome home</h1>\n" +
    "</div>"
  );
