(function () {
    ...
    function SecurityService($location, $q, AuthService, AccountService) {
    ...
    function securityAuthorizationProvider() {
      this.$get = ['SecurityService', '$location', function(security, $location) {
        var service = {
    ...
    angular.module('RomeoApp.security').factory('SecurityService', ['$location', '$q', 'AuthService', 'AccountService', SecurityService]);
