...
BLUEPRINTS = [
    ...
    for mod in
    'root', 'account', 'video', 'payments', 'contacts', 'seo'
]
...
ADMIN_APPS_DOMAIN = 'rockpack.com'
...
GOOGLE_CLIENT_ID = '551333163910-s7iuqftcp74julkp73euc804k2kvfs4n.apps.googleusercontent.com'
GOOGLE_CLIENT_SECRET = '6Cubu10G6CJth8Aqehw6UjnF'
